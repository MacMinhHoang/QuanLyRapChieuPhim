            ...
            <table align="left" cellspacing="0" style="width: 1150px; margin-bottom: 0px;">
                ...
                <tr>
                    <td class="text-center" colspan="6" style="height: 8px; font-size: larger;">
                        <asp:Button ID="Button1" runat="server" Height="53px" Text="Quản lý quản lý" Width="200px" style="margin-left: 42" BorderStyle="Double" PostBackUrl="~/QuanLyQuanLy.aspx" BorderColor="Black" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button2" runat="server" Height="53px" Text="Quản lý phòng chiếu" Width="200px" BorderStyle="Double" PostBackUrl="~/QuanLyPhongChieu.aspx" BorderColor="Black" />
                        <br />
                        <br />
